...
const CreateCourse = ({ onClose }) => {
  ...
  const handleCreateCourse = async () => {
    ...
    try {
      ...
      let result = await axios.post("/indemand/", dataToSend);
      if (result.data) {
  ...
  return (
    <div className="">
      ...
      <div className="pop-up-content prompt px-3">
        ...
        <div className="  h-[70vh] pb-4 sm:h-[70vh] overflow-y-scroll prompt">
          <form
            className=" w-[95%] sm:w-[70%]  md:w-[50%] xl:w-[45%] m-auto"
          ...
          >
            ...
            <div className="flex flex-col items-start gap-[20px] sm:gap-0 sm:flex-row sm:items-center mt-[20px] mb-[20px]  px-[5px] rounded-lg">
              <div className="flex flex-col gap-2 mt-[20px]">
                ...
                >
                  <p className="text-zinc-400">Please Select Photo</p>
